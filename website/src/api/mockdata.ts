export const APP_CONFIG = {
  ...
  logoUrl: null,
  supportEmail: "support@enandiapp.com",
  contactNumber: "+91 80 4567 8901",
  address: "No. 42, 2nd Cross, Koramangala 4th Block, Bengaluru, KA - 560034",
  currency: "₹"
};
...
/* ---------- TEST CASE 4: REFUNDED (APPROVED) ---------- */
  {
    id: 'TEST_REFUND_04',
    userId: 'user-123',
    status: 'REFUND_APPROVED', // Fixed to match STATUS_THEME
    createdAt: new Date().toISOString(),
    deliverySlot: '7-10 AM',
    address: 'TEST HOUSE, Bengaluru',
    totalAmount: 150,
    items: [{ 
      id: 'p1', 
      name: 'Farm Fresh Buffalo Milk', 
      ...
      quantity: 2, 
      unit: '1 Litre', 
      image: ['https://images.unsplash.com/photo-1563636619-e91000f21fca'] // Must be array
    }],
    adminNote: "We apologize for the sour milk. Refund of ₹150 processed to your wallet."
  },

  /* ---------- TEST CASE 5: REFUND REJECTED ---------- */
  {
    id: 'TEST_REJECT_05',
    userId: 'user-123',
    status: 'REFUND_REJECTED', // Fixed to match STATUS_THEME
    createdAt: new Date().toISOString(),
    deliverySlot: '7-10 AM',
    address: 'TEST HOUSE, Bengaluru',
    totalAmount: 90,
    items: [{ 
      ...
      quantity: 2, 
      unit: '500g', 
      image: ['https://images.unsplash.com/photo-1485962391905-dc37bcd2c73c'] // Must be array
    }],
    adminNote: "Issue rejected. The quality check pictures you provided do not show any damage."
  },
];
