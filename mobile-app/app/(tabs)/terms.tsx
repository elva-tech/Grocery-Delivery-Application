...
import { APP_BRAND, API_BASE_URL } from '@/src/config/constants';
...
export default function LegalScreen() {
  ...
  const [supportHours, setSupportHours] = useState('Mon–Sat 9:00 AM – 6:00 PM');
      ...
      try {
       ...
       const res = await fetch(`${API_BASE_URL.DEVELOPMENT}/api/tenant/details`, {
        ...
        if (data.success) {
          ...
          setSupportHours(data.supportHours || 'Mon–Sat 9:00 AM – 6:00 PM');
        }
      } catch {}
    })();
  }, []);
    ...
    support: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: supportHours || 'Mon–Sat 9:00 AM – 6:00 PM',
        },
      ],
    },
  };
